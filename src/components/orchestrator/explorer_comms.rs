...
impl Orchestrator {
    ...
    pub fn get_sender_from_orchestrator_to_explorer(&self, explorer_id: u32) -> Result<&Sender<OrchestratorToExplorer>, String> {
    ...
    pub fn send_start_explorer_ai(&mut self, explorer_id: u32) -> Result<(), String> {
        ...
        sender.send(OrchestratorToExplorer::StartExplorerAI)
            .map_err(|_| format!("Failed to send start explorer AI to explorer {}", explorer_id))?;
    ...
    pub fn send_reset_explorer_ai(&mut self, explorer_id: u32) -> Result<(), String> {
        ...
        sender.send(OrchestratorToExplorer::ResetExplorerAI)
            .map_err(|_| format!("Failed to send reset explorer AI to explorer {}", explorer_id))?;
    ...
    pub fn send_stop_explorer_ai(&mut self, explorer_id: u32) -> Result<(), String> {
        ...
        sender.send(OrchestratorToExplorer::StopExplorerAI)
            .map_err(|_| format!("Failed to send stop explorer AI to explorer {}", explorer_id))?;
    ...
    pub fn send_move_to_planet(&mut self, explorer_id: u32, planet_id: u32) -> Result<(), String> {
        ...
        sender.send(OrchestratorToExplorer::MoveToPlanet { sender_to_new_planet, planet_id })
            .map_err(|_| format!("Failed to send move to planet {} to explorer {}", planet_id, explorer_id))?;
    ...
    pub fn send_current_planet_request(&mut self, explorer_id: u32) -> Result<(), String> {
        ...
        sender.send(OrchestratorToExplorer::CurrentPlanetRequest)
            .map_err(|_| format!("Failed to send current planet request to explorer {}", explorer_id))?;
    ...
    pub fn send_supported_resource_request(&mut self, explorer_id: u32) -> Result<(), String> {
        ...
        sender.send(OrchestratorToExplorer::SupportedResourceRequest)
            .map_err(|_| format!("Failed to send supported resource request to explorer {}", explorer_id))?;
    ...
    pub fn send_supported_combination_request(&mut self, explorer_id: u32) -> Result<(), String> {
        ...
        sender.send(OrchestratorToExplorer::SupportedCombinationRequest)
            .map_err(|_| format!("Failed to send supported combination request to explorer {}", explorer_id))?;
    ...
    pub fn send_generate_resource_request(&mut self, explorer_id: u32, to_generate: BasicResourceType) -> Result<(), String> {
        let sender = self.get_sender_from_orchestrator_to_explorer(explorer_id)?;

        sender.send(OrchestratorToExplorer::GenerateResourceRequest { to_generate })
            .map_err(|_| format!("Failed to send generate resource request to explorer {}", explorer_id))?;
    ...
    pub fn send_combine_resource_request(&mut self, explorer_id: u32, to_combine: ComplexResourceType) -> Result<(), String> {
        let sender = self.get_sender_from_orchestrator_to_explorer(explorer_id)?;

        sender.send(OrchestratorToExplorer::CombineResourceRequest { to_generate: to_combine })
            .map_err(|_| format!("Failed to send combine resource request to explorer {}", explorer_id))?;
    ...
    pub fn send_bag_content_request(&mut self, explorer_id: u32) -> Result<(), String> {
        ...
        sender.send(OrchestratorToExplorer::BagContentRequest)
            .map_err(|_| format!("Failed to send bag content request to explorer {}", explorer_id))?;
    ...
    pub fn send_neighbours_response(&mut self, explorer_id: u32, planet_id: u32) -> Result<(), String> {
        let sender = self.get_sender_from_orchestrator_to_explorer(explorer_id)?;
        ...
        sender.send(OrchestratorToExplorer::NeighborsResponse { neighbors})
            .map_err(|_| format!("Failed to send neighbors response to explorer {}", explorer_id))?;
